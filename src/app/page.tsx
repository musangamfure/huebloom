...
export default function Home() {
  ...
  return (
    <main className="flex  lg:flex-row  flex-col-reverse  items-center justify-around   lg:p-24 p-10">
      <motion.div
      ...
      >
        <motion.h1
          ...
          className="lg:text-6xl text-4xl max-w-[600px] tracking-tight mx-auto font-black text-center mb-[30px]"
        >
      ...
      >
        ...
        >
          ...
          <g
            id="homepage_hero-generator-laptop-mobile"
